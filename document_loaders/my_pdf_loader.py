...
class MySimplePDFPlumberLoader(PDFPlumberLoader):
    def load(self):
        with pdfplumber.open(self.file_path) as pdf:
            for n, first_page in enumerate(pdf.pages):
                tables = first_page.extract_tables(table_settings={"vertical_strategy": "lines","snap_tolerance": 10 ,
